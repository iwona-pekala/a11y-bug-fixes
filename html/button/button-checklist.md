...
## What is a button?
1. Button is a control that is presented to assistive technologies with the button role.
2. A user can interact with a button in a predictable way (interaction is the same as for all other buttons)
