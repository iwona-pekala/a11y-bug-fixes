# Modal dialog - list of common accessibility issues and resolutions
- Keyboard focus is not moved into the modal dialog
- Screen reader focus is not moved into the modal dialog
